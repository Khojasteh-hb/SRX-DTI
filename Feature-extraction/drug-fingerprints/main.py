...
df_drug_ID = pd.read_csv('D:\my-projects\D-T prediction\Feature-extraction\drug-fingerprints\e_drug_names.csv')
...
df_smile.to_csv('D:\my-projects\D-T prediction\Feature-extraction\drug-fingerprints\e_smile.csv', index=True)
